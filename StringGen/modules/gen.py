...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@THANOS_PRO"))
            await client(JoinChannelRequest("@learningbots79"))
        else:
            ...
            await client.join_chat("THANOS_PRO")
            await client.join_chat("learningbots79")
    except KeyError:
        pass
    try:
